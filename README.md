...
![Image alt](https://github.com/AnZoro1/test-task-description/blob/main/test-image2.png)
пример
...
Выполнять с использованием Typescript
P.S - Скриншоты для примера , дизайн такой не обязательны
